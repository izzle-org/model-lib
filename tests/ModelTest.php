...
class ModelTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->book = new Book(json_decode(file_get_contents(__DIR__ . '/Mocks/book_one.json'), true, 512,
            JSON_THROW_ON_ERROR));
    }
    ...
    public function testCanBeConvertedToArray(): void
    {
        $check = static function (array $data, TestCase $phpunit) {
            ...
            $data = json_decode(file_get_contents(__DIR__ . '/Mocks/book_one.json'), true, 512, JSON_THROW_ON_ERROR);
    ...
    public function testImplementsArrayAccess(): void
    {
        ...
        $this->book['description'] = 'Nice Book';
        $this->assertEquals('Nice Book', $this->book['description']);
        
        unset($this->book['description']);
        $this->assertNull($this->book['description']);
    }
    ...
    public function testCanInstatiateIncompleteModel(): void
    {
        ...
        $this->assertEmpty($product->getMeta());
    ...
    private function checkProperties(Book $book): void
    {
        ...
        $this->assertCount(2, $book->getI18ns());
        ...
        foreach ($book->getI18ns() as $index => $i18n) {
            $this->assertEquals($index, $i18n->getLocale());
            $this->assertInstanceOf(
                BookI18n::class,
                $i18n
            );
        ...
        $this->assertNull($book->getI18ns()['de_DE']->getDescription());
        $this->assertNotNull($book->getI18ns()['en_GB']->getDescription());
    }
}
